...
trip_dates = {
    "Day1\n3/14 六": (date(2026, 3, 14), day1, "Day 1(六): 出發 & 移動"),
    "Day2\n3/15 日": (date(2026, 3, 15), day2, "Day 2(日): 金澤市區"),
    "Day3\n3/16 一": (date(2026, 3, 16), day3, "Day 3(一): 合掌村 & 飛驒"),
    "Day4\n3/17 二": (date(2026, 3, 17), day4, "Day 4(二): 新穗高 & 高山"),
    "Day5\n3/18 三": (date(2026, 3, 18), day5, "Day 5(三): 牧歌 & 犬山"),
    "Day6\n3/19 四": (date(2026, 3, 19), day6, "Day 6(四): 名古屋榮商圈"),
    "Day7\n3/20 五": (date(2026, 3, 20), day7, "Day 7(五): 大須 & 名古屋城"),
    "Day8\n3/21 六": (date(2026, 3, 21), day8, "Day 8(六): 回程"),
}
